<template>
  <div class="classes-main">
    <div class="classes-search-div">
      <auto-complete-input
        :dataList="['Core Java', 'Green Computing', 'Python', 'Ruby On Rails']"
    ...
    <div class="classes-list-div">
      ...
      <div class="classes-table">
        <div class="table-row header blue">
          ...
          <div class="cell">Title of Subject</div>
          <div class="cell"></div>
          <div class="cell"></div>
        </div>
        <div class="table-row">
          <div class="cell" data-title="id">1</div>
          <div class="cell">FYCS</div>
          <div class="cell">4</div>
          <div class="cell" data-title="title"><a href="#">Core Java</a></div>
          <div class="cell">
            <router-link :to="{ name: 'addSubject', params: { id: 1342 } }">
              <span>
        ...
        <div class="table-row">
          ...
          <div class="cell">TY</div>
          <div class="cell">2</div>
          <div class="cell" data-title="title"><a href="#">Python</a></div>
          <div class="cell">
            <span>
              <box-icon name="edit-alt"></box-icon>
            </span>
