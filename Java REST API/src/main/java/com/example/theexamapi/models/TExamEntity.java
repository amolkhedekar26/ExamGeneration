...
public class TExamEntity {
    ...
    public String getUidSubjectFk() {
        return uidSubjectFk;
    }

    public void setUidSubjectFk(String uidSubjectFk) {
    ...
    public boolean equals(Object o) {
        ...
        TExamEntity that = (TExamEntity) o;
