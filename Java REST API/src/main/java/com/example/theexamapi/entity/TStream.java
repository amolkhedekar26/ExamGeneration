...
@Entity
@Table(name = "t_stream", schema = "exam_api_db", catalog = "")
public class TStream {
    @Basic
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "jstream_id")
    private int jstreamId;

    @Id
    @Column(name = "uid_stream")
    private String uidStream;
    @Basic
    @Column(name = "stitle")
    ...
    public int getJstreamId() {
        return jstreamId;
    }

    public void setJstreamId(int jstreamId) {
        this.jstreamId = jstreamId;
    }

    public String getUidStream() {
        return uidStream;
    }

    public void setUidStream(String uidStream) {
        this.uidStream = uidStream;
    }
    ...
    public boolean equals(Object o) {
        ...
        TStream that = (TStream) o;
        return jstreamId == that.jstreamId && jstatus == that.jstatus && Objects.equals(uidStream, that.uidStream) && Objects.equals(stitle, that.stitle) && Objects.equals(sdetails, that.sdetails) && Objects.equals(dtcreatedAt, that.dtcreatedAt) && Objects.equals(uidCreatedByFk, that.uidCreatedByFk) && Objects.equals(uidUpdatedByFk, that.uidUpdatedByFk) && Objects.equals(uidPrevious, that.uidPrevious);
    }

    @Override
    public int hashCode() {
        return Objects.hash(jstreamId, uidStream, stitle, sdetails, jstatus, dtcreatedAt, uidCreatedByFk, uidUpdatedByFk, uidPrevious);
    }
}
